...
/**
 * Gets the current time and if the current time is not up to date the sntp_time_sync_init_sntp function is called
*/
...
{
    xTaskCreatePinnedToCore(&sntp_time_sync,"sntp_time_sync", SNTP_TIME_SYNC_TASKS_STACK_SIZE, NULL, SNTP_TIME_SYNC_TASK_PRIORITY, NULL, SNTP_TIME_SYNC_TASK_CORE_ID);
}